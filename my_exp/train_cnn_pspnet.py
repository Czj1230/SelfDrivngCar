...
import cnnmodel_identify
import cnnmodel_relu
import cnnmodel_sigmoid
import numpy as np
import matplotlib.pyplot as plt
import time

models = (cnnmodel_identify, cnnmodel_relu,cnnmodel_sigmoid)
...
x_axis = [(i + 1) * 5 for i in range(len(result[0]))]
plt.figure()
plt.plot(x_axis, result[0], label='Sum-of-Square Error Loss for Identify Function')
plt.plot(x_axis, result[1], label='Sum-of-Square Error Loss for ReLU Function')
plt.plot(x_axis, result[2], label='Sum-of-Square Error Loss for Sigmoid Function')
