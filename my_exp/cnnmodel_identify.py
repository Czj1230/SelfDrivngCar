...
W_conv1 = weight_variable([5, 5, 3, 24]) # patch 5x5, in size 3, out size 24, 也即5x5x3的卷积核有24个
b_conv1 = bias_variable([24])

h_conv1 = (conv2d(x_image, W_conv1, 2) + b_conv1)

#second convolutional layer
W_conv2 = weight_variable([5, 5, 24, 36])
b_conv2 = bias_variable([36])

h_conv2 = (conv2d(h_conv1, W_conv2, 2) + b_conv2)

#third convolutional layer
W_conv3 = weight_variable([5, 5, 36, 48])
b_conv3 = bias_variable([48])

h_conv3 = (conv2d(h_conv2, W_conv3, 2) + b_conv3)
