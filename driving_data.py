...
#read data.txt
with open("driving_dataset_ori_3050/dataset_3050.txt") as f:
    for line in f:
        xs.append("driving_dataset_ori_3050/" + line.split()[0])
        #the paper by Nvidia uses the inverse of the turning radius,
        #but steering wheel angle is proportional to the inverse of turning radius
        #so the steering wheel angle in radians is used as the output
        ys.append(float(line.split()[1]) * 3.14159265 / 180)

# with open("driving_dataset_pspnet101/dataset_3050.txt") as f:
#     count=0
#     for line in f:
#         xs.append("driving_dataset_pspnet101/" + str(count)+"_seg.jpg")
#         #the paper by Nvidia uses the inverse of the turning radius,
#         #but steering wheel angle is proportional to the inverse of turning radius
#         #so the steering wheel angle in radians is used as the output
#         ys.append(float(line.split()[1]) * 3.14159265 / 180)
